...
<head>
  ...
  <meta name="author" content="lotussoft.com.np">
  <title>Record Dashboard - Dashboard </title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">LSYT IT</h6>
            </div>
        ...
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-upgrade">
            <div class="card-header text-center border-bottom-0">
              ...
              <p class="card-category">Are you looking for more components? Please check our Premium Version of Argon
                Dashboard.</p>
            </div>
            <div class="card-body">
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; {{ now()->year }} <a href="https://lotussoft.com.np" class="font-weight-bold ml-1"
                target="_blank">lotussoft.com.np</a>
            </div>
          </div>
          <div class="col-xl-6">
