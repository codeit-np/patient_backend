      ...
      <div class="card shadow border-0">
        ...
        <div class="card-body px-lg-5 py-lg-5">
          <div class="text-center text-muted mb-4">
            <small>{{ __('Sign up with new credentials') }}</small>
          </div>
          <form role="form" method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
              <div class="input-group input-group-alternative mb-3">
                ...
                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Name') }}" type="text" name="name" value="{{ old('name') }}" required autofocus>
              </div>
              @if ($errors->has('name'))
            ...
            <div class="text-muted font-italic">
              <small>{{ __('password strength') }}:
                <!-- <span class="text-success font-weight-700">{{ __('strong') }}strong</span></small> -->
            </div>
            <div class="row my-4">
              <div class="col-12">
